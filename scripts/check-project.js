...
const required = [
  ...
  'js/app.js', 'js/store.js', 'js/config.js', 'js/push-config.js', 'supabase/schema.sql',
...
for (const expected of ['enable row level security', 'create_agenda_family', 'join_agenda_family', 'rotate_family_invite', 'update_family_identity', 'update_member_presentation', 'responsible_member_id', 'recurrence_rule', 'reminder_minutes', 'create table if not exists public.tasks', 'create table if not exists public.shopping_items', 'create table if not exists public.routines', 'create table if not exists public.routine_completions', 'create table if not exists public.content_comments', 'create table if not exists public.content_reactions', 'create table if not exists public.content_reads', 'create table if not exists public.content_attachments', 'create table if not exists public.activity_log', 'agenda-attachments', 'notification_preferences', 'user_preferences', 'push_subscriptions', 'notification_change_events', 'notification_snoozes', 'snooze_my_notification', 'departure_reminders', 'get_due_push_notifications', 'supabase_realtime']) {
